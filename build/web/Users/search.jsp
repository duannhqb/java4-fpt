...
<div id="page-wrapper">
    <div class="container">
        <div class="row" style="margin-top: 20px">
            <div class="col-md-4">
                <a href="UserController?action=go-to-list-form" class="btn btn-primary" style="margin-top: 20px; margin-left: -5px;">Trở lại</a>
            </div>
        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <i class="fa fa-bar-chart-o fa-fw"></i> FIND USER
                    ...
                    <div class="pull-right">
                        <div class="btn-group">
                            ...
                            <ul class="dropdown-menu pull-right" role="menu">
                                <li><a href="UserController?action=go-to-add-form">Thêm mới USER</a>
                                </li>
                            </ul>
                        </div>
                    </div>
                            ...
                            <c:forEach var="user" items="${listUser}">
                                <tr>
                                    ...
                                    <td class="text-center">
                                        ...
                                        <button class="btn button btn-warning btn-sm remove-user-dashboad">
                                            <div class="ripples buttonRipples">
                                                <span class="ripplesCircle"></span>
                                            </div>
