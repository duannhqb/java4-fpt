            ...
            <form action="CategoryController" method="GET">
                <div class="panel panel-default" style="margin-top: 20px;">
                    <div class="panel-heading">
                        <i class="fa fa-bar-chart-o fa-fw"></i> CẬP NHẬT LOẠI SẢN PHẨM
                    </div>
                    <div class="panel-body">
                        <div class="form-group">
                            <label for="categoryName">Tên loại sản phẩm</label>
                            <input type="text" class="form-control" name="categoryName" id="categoryName" placeholder="Nhập tên loại sản phẩm" value="${category.categoryName}">
                        </div>
                    </div>
                    <!--end panel body--> 
